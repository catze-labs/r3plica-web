  ...
  return (
    <AssetBox className="sm:w-[800px]">
      ...
      <div className="flex flex-col sm:flex-row w-full gap-4 sm:gap-4 py-4">
        <ul className="relative w-1/2 p-4 sm:p-8 grow flex flex-col gap-4 h-[350px] overflow-y-auto bg-[rgba(255,255,255,0.05)] rounded-lg scrollbar-thumb-gray-500 scrollbar-thin scrollbar-track-gray-400">
          {isLoading && (
        ...
        <ul className="relative w-1/2 p-8 grow flex flex-col gap-4 h-[350px] overflow-y-auto bg-[rgba(255,255,255,0.05)] rounded-lg scrollbar-thumb-gray-500 scrollbar-thin scrollbar-track-gray-400">
          {isLoading && (
            <li className="text-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
              Loading...
            </li>
